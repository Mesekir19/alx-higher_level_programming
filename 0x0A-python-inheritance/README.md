# Inheritance
Project done during **Full Stack Software Engineering studies** at **ALX Holberton School**. It aims to learn about inheritance, superclass, baseclass and subclass in **Python**.
